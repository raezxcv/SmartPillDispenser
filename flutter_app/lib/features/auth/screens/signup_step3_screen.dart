...
/// Signup Step 3 of 3 — "Email and Password"
...
class _SignupStep3ScreenState extends State<SignupStep3Screen> {
  ...
  Future<void> _submitRegistration() async {
    ...
    // If standard email registration, check password match
    ...
    try {
      String? error;
      if (widget.googleUid != null) {
        // Complete Google / Facebook sign-in profile
        ...
        // Standard Firebase Email/Password signup
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration:
                              _buildPillInputDecoration('you@example.com'),
                        ...
                        if (!isGoogleUser) ...[
                          ...
                          TextFormField(
                            ...
                            decoration:
                                _buildPillInputDecoration('At least 8 characters')
                                    .copyWith(
                          ...
                          TextFormField(
                            ...
                            decoration:
                                _buildPillInputDecoration('Repeat your password')
                                    .copyWith(
                              suffixIcon: IconButton(
                                icon: Icon(
                                  _obscureConfirm
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color:
                        _isLoading ? const Color(0xFFD1D5DB) : null,
